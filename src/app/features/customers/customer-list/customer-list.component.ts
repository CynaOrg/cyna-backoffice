  ...
  template: `
    <div>
      <div class="mb-6">
        ...
        <p class="text-sm text-text-secondary mt-1">Manage registered users</p>
      </div>
...
export class CustomerListComponent implements OnInit {
  ...
  loadUsers() {
    ...
    this.api.getRaw<any>('admin/users', params).subscribe({
      next: (res) => {
      ...
      error: () => {
        this.notifications.error('Failed to load customers');
        this.loading.set(false);
      },
    });
  }
